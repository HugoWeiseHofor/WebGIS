...
var format_Frededeomrder_8 = new ol.format.GeoJSON();
var features_Frededeomrder_8 = format_Frededeomrder_8.readFeatures(json_Frededeomrder_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Frededeomrder_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Frededeomrder_8.addFeatures(features_Frededeomrder_8);
var lyr_Frededeomrder_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Frededeomrder_8, 
                style: style_Frededeomrder_8,
                popuplayertitle: 'Fredede områder',
                interactive: true,
                title: '<img src="styles/legend/Frededeomrder_8.png" /> Fredede områder'
            });
var format_Jordforureningvidenniveau2V2_9 = new ol.format.GeoJSON();
var features_Jordforureningvidenniveau2V2_9 = format_Jordforureningvidenniveau2V2_9.readFeatures(json_Jordforureningvidenniveau2V2_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jordforureningvidenniveau2V2_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jordforureningvidenniveau2V2_9.addFeatures(features_Jordforureningvidenniveau2V2_9);
var lyr_Jordforureningvidenniveau2V2_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jordforureningvidenniveau2V2_9, 
                style: style_Jordforureningvidenniveau2V2_9,
                popuplayertitle: 'Jordforurening videnniveau 2 (V2)',
                interactive: true,
                title: '<img src="styles/legend/Jordforureningvidenniveau2V2_9.png" /> Jordforurening videnniveau 2 (V2)'
            });
var format_Jordforureningvidenniveau1V1_10 = new ol.format.GeoJSON();
var features_Jordforureningvidenniveau1V1_10 = format_Jordforureningvidenniveau1V1_10.readFeatures(json_Jordforureningvidenniveau1V1_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jordforureningvidenniveau1V1_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jordforureningvidenniveau1V1_10.addFeatures(features_Jordforureningvidenniveau1V1_10);
var lyr_Jordforureningvidenniveau1V1_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jordforureningvidenniveau1V1_10, 
                style: style_Jordforureningvidenniveau1V1_10,
                popuplayertitle: 'Jordforurening videnniveau 1 (V1)',
                interactive: true,
                title: '<img src="styles/legend/Jordforureningvidenniveau1V1_10.png" /> Jordforurening videnniveau 1 (V1)'
            });
var format_DigitaliseringafvdomrderfraDeHjeMlebordblade_11 = new ol.format.GeoJSON();
var features_DigitaliseringafvdomrderfraDeHjeMlebordblade_11 = format_DigitaliseringafvdomrderfraDeHjeMlebordblade_11.readFeatures(json_DigitaliseringafvdomrderfraDeHjeMlebordblade_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DigitaliseringafvdomrderfraDeHjeMlebordblade_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DigitaliseringafvdomrderfraDeHjeMlebordblade_11.addFeatures(features_DigitaliseringafvdomrderfraDeHjeMlebordblade_11);
var lyr_DigitaliseringafvdomrderfraDeHjeMlebordblade_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_DigitaliseringafvdomrderfraDeHjeMlebordblade_11, 
                style: style_DigitaliseringafvdomrderfraDeHjeMlebordblade_11,
                popuplayertitle: 'Digitalisering af vådområder fra De Høje Målebordblade',
                interactive: true,
                title: '<img src="styles/legend/DigitaliseringafvdomrderfraDeHjeMlebordblade_11.png" /> Digitalisering af vådområder fra De Høje Målebordblade'
            });
...
var format_Risikoforoversvmmelse_22 = new ol.format.GeoJSON();
var features_Risikoforoversvmmelse_22 = format_Risikoforoversvmmelse_22.readFeatures(json_Risikoforoversvmmelse_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Risikoforoversvmmelse_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Risikoforoversvmmelse_22.addFeatures(features_Risikoforoversvmmelse_22);
var lyr_Risikoforoversvmmelse_22 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Risikoforoversvmmelse_22, 
                style: style_Risikoforoversvmmelse_22,
                popuplayertitle: 'Risiko for oversvømmelse',
                interactive: true,
                title: '<img src="styles/legend/Risikoforoversvmmelse_22.png" /> Risiko for oversvømmelse'
            });
var format_Spildevandskloakering_23 = new ol.format.GeoJSON();
var features_Spildevandskloakering_23 = format_Spildevandskloakering_23.readFeatures(json_Spildevandskloakering_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Spildevandskloakering_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Spildevandskloakering_23.addFeatures(features_Spildevandskloakering_23);
var lyr_Spildevandskloakering_23 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Spildevandskloakering_23, 
                style: style_Spildevandskloakering_23,
                popuplayertitle: 'Spildevandskloakering',
                interactive: true,
                title: '<img src="styles/legend/Spildevandskloakering_23.png" /> Spildevandskloakering'
            });
var format_IngenKloakering_24 = new ol.format.GeoJSON();
var features_IngenKloakering_24 = format_IngenKloakering_24.readFeatures(json_IngenKloakering_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_IngenKloakering_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_IngenKloakering_24.addFeatures(features_IngenKloakering_24);
var lyr_IngenKloakering_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_IngenKloakering_24, 
                style: style_IngenKloakering_24,
                popuplayertitle: 'Ingen Kloakering',
                interactive: true,
                title: '<img src="styles/legend/IngenKloakering_24.png" /> Ingen Kloakering'
            });
var format_VedtagetSeperatkloakering_25 = new ol.format.GeoJSON();
var features_VedtagetSeperatkloakering_25 = format_VedtagetSeperatkloakering_25.readFeatures(json_VedtagetSeperatkloakering_25, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VedtagetSeperatkloakering_25 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VedtagetSeperatkloakering_25.addFeatures(features_VedtagetSeperatkloakering_25);
var lyr_VedtagetSeperatkloakering_25 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VedtagetSeperatkloakering_25, 
                style: style_VedtagetSeperatkloakering_25,
                popuplayertitle: 'Vedtaget Seperatkloakering',
                interactive: true,
                title: '<img src="styles/legend/VedtagetSeperatkloakering_25.png" /> Vedtaget Seperatkloakering'
            });
var format_Vallensbk_26 = new ol.format.GeoJSON();
var features_Vallensbk_26 = format_Vallensbk_26.readFeatures(
    json_Vallensbk_26,
    {
...
var jsonSource_Vallensbk_26 = new ol.source.Vector({
    attributions: ' '
});
jsonSource_Vallensbk_26.addFeatures(features_Vallensbk_26);
var lyr_Vallensbk_26 = new ol.layer.Vector({
    declutter: false,
    source: jsonSource_Vallensbk_26,
    style: style_Vallensbk_26,
    popuplayertitle: 'Vallensbæk',
    interactive: false,
    opacity: 1,
    title: '<img src="styles/legend/Vallensbk_26.png" /> Vallensbæk'
});

var group_Kloakering = new ol.layer.Group({
                                layers: [lyr_Vallensbk_26,],
                                fold: 'closed',
                                title: 'Vallensbæk'});

var group_Kloakering = new ol.layer.Group({
                                layers: [lyr_Spildevandskloakering_23,lyr_IngenKloakering_24,lyr_VedtagetSeperatkloakering_25,],
                                fold: 'open',
                                title: 'Kloakering'});
var group_RisikoforoversvmmelseKystdirektoratet = new ol.layer.Group({
                                layers: [lyr_Risikoforoversvmmelse_22,],
                                fold: 'close',
                                title: 'Risiko for oversvømmelse (Kystdirektoratet)'});
// --- Child groups that will be nested ---
var group_Vandlb = new ol.layer.Group({
    layers: [
        lyr_Vandlb100mbuffer_12,
        lyr_Vandlb20mbuffer_13,
        lyr_Vandlb10mbuffer_14,
        lyr_Vandlb2mbuffer_15,
        lyr_Vandlb_16
    ],
    fold: 'close',
    title: 'Vandløb'
...
var group_jordforurening = new ol.layer.Group({
    layers: [       
        lyr_Jordforureningvidenniveau2V2_9,
        lyr_Jordforureningvidenniveau1V1_10
    ],
    fold: 'close',
...
var group_MSKEIKKEkort = new ol.layer.Group({
    layers: [
        group_Ser, 
        group_Vandlb,  
        group_RisikoforoversvmmelseKystdirektoratet,
        group_jordforurening,
        lyr_Frededeomrder_8,
        lyr_DigitaliseringafvdomrderfraDeHjeMlebordblade_11
    ],
    fold: 'open',
...
lyr_ESRIGraylight_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_Antropogentlandskab_2.setVisible(false);lyr_Bundmorneflade_3.setVisible(false);lyr_Erosionsdal_4.setVisible(false);lyr_Marinflade_5.setVisible(false);lyr_Strandvold_6.setVisible(false);lyr_S_7.setVisible(false);lyr_Frededeomrder_8.setVisible(true);lyr_Jordforureningvidenniveau2V2_9.setVisible(true);lyr_Jordforureningvidenniveau1V1_10.setVisible(true);lyr_DigitaliseringafvdomrderfraDeHjeMlebordblade_11.setVisible(true);lyr_Vandlb100mbuffer_12.setVisible(true);lyr_Vandlb20mbuffer_13.setVisible(true);lyr_Vandlb10mbuffer_14.setVisible(true);lyr_Vandlb2mbuffer_15.setVisible(true);lyr_Vandlb_16.setVisible(true);lyr_Ser100mbuffer_17.setVisible(true);lyr_Ser20mbuffer_18.setVisible(true);lyr_Ser10mbuffer_19.setVisible(true);lyr_Ser2mbuffer_20.setVisible(true);lyr_Ser_21.setVisible(true);lyr_Risikoforoversvmmelse_22.setVisible(true);lyr_Spildevandskloakering_23.setVisible(true);lyr_IngenKloakering_24.setVisible(true);lyr_VedtagetSeperatkloakering_25.setVisible(true);lyr_Vallensbk_26.setVisible(true);
var layersList = [group_Baggrundskort,group_GeomorfologiGEUS,group_MSKEIKKEkort,group_IKKEkort];
...
lyr_Ser_21.set('fieldAliases', {'fid': 'fid', 'status': 'status', 'geometristatus': 'geometristatus', 'registreringsspecifikation': 'registreringsspecifikation', 'dataansvar': 'dataansvar', 'forretningshaendelse': 'forretningshaendelse', 'forretningsomraade': 'forretningsomraade', 'forretningsproces': 'forretningsproces', 'registreringsaktoer': 'registreringsaktoer', 'registreringfra': 'registreringfra', 'registreringtil': 'registreringtil', 'virkningsaktoer': 'virkningsaktoer', 'virkningfra': 'virkningfra', 'virkningtil': 'virkningtil', 'plannoejagtighed': 'plannoejagtighed', 'planstedfaestelsesmetode': 'planstedfaestelsesmetode', 'vertikalnoejagtighed': 'vertikalnoejagtighed', 'vertikalstedfaestelsesmetode': 'vertikalstedfaestelsesmetode', 'applikation': 'applikation', 'kommentar': 'kommentar', 'soetype': 'soetype', 'vanduuid': 'vanduuid', 'underminimumsoe': 'underminimumsoe', 'link': 'link', });
lyr_Risikoforoversvmmelse_22.set('fieldAliases', {'fid': 'fid', 'DN': 'DN', });
lyr_Spildevandskloakering_23.set('fieldAliases', {'fid': 'fid', 'doklink': 'doklink', 'uuid': 'uuid', 'temakode': 'temakode', 'temanavn': 'temanavn', 'objekt_id': 'objekt_id', 'systid_fra': 'systid_fra', 'oprettet': 'oprettet', 'oprindkode': 'oprindkode', 'oprindelse': 'oprindelse', 'statuskode': 'statuskode', 'status': 'status', 'cvr_kode': 'cvr_kode', 'cvrname': 'cvrname', 'bruger_id': 'bruger_id', 'link': 'link', 'navn1201': 'navn1201', 'type1201a': 'type1201a', 'vaerd1201a': 'vaerd1201a', 'type1201b': 'type1201b', 'vaerd1201b': 'vaerd1201b', 'staar1201': 'staar1201', 'sluaar1201': 'sluaar1201', 'datoforsl': 'datoforsl', 'datovedt': 'datovedt', 'datoaflyst': 'datoaflyst', 'datoikraft': 'datoikraft', 'datostart': 'datostart', 'datoslut': 'datoslut', });
lyr_IngenKloakering_24.set('fieldAliases', {'fid': 'fid', 'doklink': 'doklink', 'uuid': 'uuid', 'temakode': 'temakode', 'temanavn': 'temanavn', 'objekt_id': 'objekt_id', 'systid_fra': 'systid_fra', 'oprettet': 'oprettet', 'oprindkode': 'oprindkode', 'oprindelse': 'oprindelse', 'statuskode': 'statuskode', 'status': 'status', 'cvr_kode': 'cvr_kode', 'cvrname': 'cvrname', 'bruger_id': 'bruger_id', 'link': 'link', 'navn1201': 'navn1201', 'type1201a': 'type1201a', 'vaerd1201a': 'vaerd1201a', 'type1201b': 'type1201b', 'vaerd1201b': 'vaerd1201b', 'staar1201': 'staar1201', 'sluaar1201': 'sluaar1201', 'datoforsl': 'datoforsl', 'datovedt': 'datovedt', 'datoaflyst': 'datoaflyst', 'datoikraft': 'datoikraft', 'datostart': 'datostart', 'datoslut': 'datoslut', 'CG_ID': 'CG_ID', 'navn': 'navn', 'regionskode': 'regionskode', 'udtraeksdato': 'udtraeksdato', 'kommunekode': 'kommunekode', 'udenforkommuneinddeling': 'udenforkommuneinddeling', });
lyr_VedtagetSeperatkloakering_25.set('fieldAliases', {'fid': 'fid', 'doklink': 'doklink', 'uuid': 'uuid', 'temakode': 'temakode', 'temanavn': 'temanavn', 'objekt_id': 'objekt_id', 'systid_fra': 'systid_fra', 'oprettet': 'oprettet', 'oprindkode': 'oprindkode', 'oprindelse': 'oprindelse', 'statuskode': 'statuskode', 'status': 'status', 'cvr_kode': 'cvr_kode', 'cvrname': 'cvrname', 'bruger_id': 'bruger_id', 'link': 'link', 'navn1201': 'navn1201', 'type1201a': 'type1201a', 'vaerd1201a': 'vaerd1201a', 'type1201b': 'type1201b', 'vaerd1201b': 'vaerd1201b', 'staar1201': 'staar1201', 'sluaar1201': 'sluaar1201', 'datoforsl': 'datoforsl', 'datovedt': 'datovedt', 'datoaflyst': 'datoaflyst', 'datoikraft': 'datoikraft', 'datostart': 'datostart', 'datoslut': 'datoslut', });
lyr_Vallensbk_26.set('fieldAliases', {'fid': 'fid', 'navn': 'navn', });
...
lyr_DigitaliseringafvdomrderfraDeHjeMlebordblade_11.set('fieldImages', {'fid': 'TextEdit', });
...
lyr_DigitaliseringafvdomrderfraDeHjeMlebordblade_11.set('fieldLabels', {'fid': 'no label', });
...
lyr_VedtagetSeperatkloakering_25.set('fieldLabels', {'fid': 'no label', 'doklink': 'no label', 'uuid': 'no label', 'temakode': 'no label', 'temanavn': 'no label', 'objekt_id': 'no label', 'systid_fra': 'no label', 'oprettet': 'no label', 'oprindkode': 'no label', 'oprindelse': 'no label', 'statuskode': 'no label', 'status': 'no label', 'cvr_kode': 'no label', 'cvrname': 'no label', 'bruger_id': 'no label', 'link': 'no label', 'navn1201': 'no label', 'type1201a': 'no label', 'vaerd1201a': 'no label', 'type1201b': 'no label', 'vaerd1201b': 'no label', 'staar1201': 'no label', 'sluaar1201': 'no label', 'datoforsl': 'no label', 'datovedt': 'no label', 'datoaflyst': 'no label', 'datoikraft': 'no label', 'datostart': 'no label', 'datoslut': 'no label', });
lyr_Vallensbk_26.set('fieldLabels', {'fid': 'no label', 'navn': 'no label', });
lyr_Vallensbk_26.on('precompose', function(evt) {
    evt.context.globalCompositeOperation = 'normal';
});
map.addLayer(lyr_Vallensbk_26);
